...
- `破壊の目` / `狂気` 以外の新軸として、場で発生した HP ダメージ量を数える `Bloodshed` の初回スライスを追加した。
...
- `Bloodshed` の次手は [bloodshed-design-note.md](./bloodshed-design-note.md) を起点に、条件参照・スケーリング・消費のうち 1 つだけを検証する追加 1 枚へ絞る。
